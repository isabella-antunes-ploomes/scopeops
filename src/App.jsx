...
function AgentChatPhase({agentKey,cfg,scopeText,fileParts,prevContext,savedMessages,onAdvance,onBack,modelKey,onModelChange}){
  ...
  return (
    <div style={{background:T.n0,border:"1px solid "+T.n100,borderRadius:T.r12,boxShadow:T.shadowMd,overflow:"hidden"}}>
      ...
      <div style={{minHeight:400,maxHeight:"60vh",overflowY:"auto",padding:16,display:"flex",flexDirection:"column",gap:12,background:T.n50,...(initializing?{alignItems:"center",justifyContent:"center"}:{})}}>
        {initializing&&<div style={{padding:"80px 0"}}><Spinner label={cfg.name+" analisando…"} color={meta.color}/></div>}
        {messages.map((msg,i)=>(
